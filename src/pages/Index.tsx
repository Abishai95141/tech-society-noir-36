            ...
            <aside className="md:col-span-1 flex flex-col justify-between pointer-events-auto md:pl-[12%]">
              ...
              <div className="flex justify-start">
                <div className="relative">
                  ...
                  <span aria-hidden className="absolute inset-0 block font-extrabold tracking-tight leading-[0.9] text-foreground text-[clamp(64px,12vw,160px)] -tracking-[0.02em] blur-sm opacity-50">Tech</span>
                  {/* Main text with border */}
                  <span aria-hidden className="relative block font-extrabold tracking-tight leading-[0.9] text-foreground text-[clamp(64px,12vw,160px)] -tracking-[0.02em] [text-shadow:2px_2px_0_white,-2px_-2px_0_white,2px_-2px_0_white,-2px_2px_0_white] [-webkit-text-stroke:2px_white]">Tech</span>
                  {/* White blend overlay */}
                  <span aria-hidden className="absolute inset-0 block font-extrabold tracking-tight leading-[0.9] text-white text-[clamp(64px,12vw,160px)] -tracking-[0.02em] mix-blend-mode-difference [text-shadow:2px_2px_0_white,-2px_-2px_0_white,2px_-2px_0_white,-2px_2px_0_white] [-webkit-text-stroke:2px_white]">Tech</span>
                </div>
              </div>
            </aside>
            ...
            <aside className="md:col-span-1 flex flex-col justify-between text-right gap-6">
              ...
              <div className="space-y-6">
                <div className="flex justify-end">
                  <div className="relative">
                    {/* Blur effect background */}
                    <span aria-hidden className="absolute inset-0 block font-extrabold tracking-tight leading-[0.9] text-foreground text-[clamp(64px,12vw,160px)] -tracking-[0.02em] blur-sm opacity-50">Society</span>
                    {/* Main text with border */}
                    <span aria-hidden className="relative block font-extrabold tracking-tight leading-[0.9] text-foreground text-[clamp(64px,12vw,160px)] -tracking-[0.02em] [text-shadow:2px_2px_0_white,-2px_-2px_0_white,2px_-2px_0_white,-2px_2px_0_white] [-webkit-text-stroke:2px_white]">Society</span>
                    {/* White blend overlay */}
